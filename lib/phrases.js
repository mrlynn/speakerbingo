export const PHRASE_CATEGORIES = {
  'sunrise-regulars': {
    ...
    phrases: [
      ...
      'Um', 'Like', 'At the end of the day', 'Just saying', 'Right?', "If I'm being honest", "For what it's worth",'you\'re muted',
      'That being said', 'You get the picture', 'Honestly', 'Kind of', 'Sort of', 'So', 'Basically', 'Moving on', 'Gonna','blabla',
      ...
      'proof of the pudding', 'utilize don\'t analyze', 'I\'m not a doctor', 'I\'m not a lawyer', 'I\'m not a therapist',
      'keep coming back','fake it till you make it', 'stick with the winners', 'take what you like and leave the rest',
      'principles before personalities', 'when all else fails, follow directions', 'meeting makers make it', 'call your sponsor',
      'read the book', 'get a sponsor', 'work the steps', 'help another alcoholic', 'attitude of gratitude', 'act as if',
      'first drink, first drunk', 'stinking thinking', 'dry drunk', 'white knuckle sobriety', 'geographic cure',
      'slip vs relapse', 'bottom line', 'rock bottom', 'gift of desperation', 'My ego is not my amigo'
    ]
  },
